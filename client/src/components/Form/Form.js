...
const Form = ({currentId, setCurrentId}) => {
        ...
        return (
            <Paper className={classes.paper}>
                <Typography variant="h6" align="center">
                    Login in to create a memory and access other features
                </Typography>
            </Paper>
        )
    }
    ...
    return ( 
        <Paper className={classes.paper} elevation={6} >
            ...
            <Button className={classes.buttonSubmit} variant="contained" color="primary" size="large" type="submit" fullWidth>Sumbit</Button>
